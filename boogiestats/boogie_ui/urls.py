...
urlpatterns = [
    ...
    path("players/<int:player_id>/gs_failed", views.PlayerGSFailedView.as_view(), name="player_gs_failed"),
    path("players/<int:player_id>/gs_skipped", views.PlayerGSSkippedView.as_view(), name="player_gs_skipped"),
